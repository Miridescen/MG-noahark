...
import { Stake, ChooseBond, Bond, TreasuryDashboard, Calculator } from "./views";
          ...
          <div className={`app ${isSmallerScreen && "tablet"} ${isSmallScreen && "mobile"} ${theme}`}>
            ...
            <div className={`${classes.content} ${isSmallerScreen && classes.contentShift}`}>
              <Switch>
                ...
                <Route path="/app/bonds">
                  {(bonds as IAllBondData[]).map(bond => {
                    return (
                      <Route exact key={bond.name} path={`/app/bonds/${bond.name}`}>
                        <Bond bond={bond} />
                      </Route>
                    );
                  })}
