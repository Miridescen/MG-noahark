...
export interface MigrateContractInterface extends utils.Interface {
  functions: {
...
export interface MigrateContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MigrateContractInterface;
