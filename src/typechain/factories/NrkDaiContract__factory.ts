...
export class NrkDaiContract__factory {
  static readonly abi = _abi;
  static createInterface(): NrkDaiContractInterface {
    return new utils.Interface(_abi) as NrkDaiContractInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): NrkDaiContract {
    return new Contract(address, _abi, signerOrProvider) as NrkDaiContract;
  }
}
